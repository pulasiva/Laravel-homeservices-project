            ...
            <form action="scripts/register.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="profession" id="profession">
                        ...
                        <option value="ac" >Ac Repairer</option>
                        <option value="tv" >TV Repairer</option>
                        <option value="washing" >Washing Meachine Repairer</option>
                        <option value="fridge" >Fridge Repairer</option>
                        <option value="carpenter" >Carpenter</option>
                        <option value="laundry" >Laundry</option>
                        <option value="home inspection service" >Home inspection Service</option>
